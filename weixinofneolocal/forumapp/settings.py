...
DATABASES = {
    'default': {
        ...
        'NAME': 'forumappdemo',  # Or path to database file if using sqlite3.
...
FORUM_USE_RECAPTCHA = False  # if true will show recaptha for users with < 5 posts
...
SECRET_KEY = 'jkmes^j1iim))y5uj=(okj4qcf_50+a#^!870z)04%e55%o4cr'
