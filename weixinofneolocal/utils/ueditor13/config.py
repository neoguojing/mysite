...
def getImagePathConfig(image_path='http://weixinofneo-media.stor.sinaapp.com/image/', video_path='http://weixinofneo-media.stor.sinaapp.com/video/', file_path='http://weixinofneo-media.stor.sinaapp.com/'):
    ued_config = { 'upload' };
    return ued_config;
